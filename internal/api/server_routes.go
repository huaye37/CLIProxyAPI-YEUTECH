...
func (s *Server) setupRoutes() {
	...
	v1.Use(AuthMiddleware(s.accessManager))
	{
		...
		v1.GET("/model-capabilities", s.modelCapabilitiesHandler)
...
// modelCapabilitiesHandler exposes the safe, runtime-filtered capability
// catalog shared by workbenches. Credentials and provider runtime details are
